...
2. Combine subject, activity and features data into a test and training
...
6. Exports first tidy data set to file system "merged_data.txt"
...
8. Exports second tidy data set to file system with the average of each variable for each activity and each subject.